    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-white border-b border-gray-200 px-5 py-3.5 sticky top-0 z-50">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <a
            href="/about"
            className="text-sm font-medium text-[#d31464] hover:underline transition-colors"
          >
            About Us
          </a>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-3.5 border border-gray-300 rounded-md text-base text-gray-900 placeholder-gray-400 outline-none focus:border-[#d31464] transition-colors"
            />
          </div>
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              onChange={handleChange}
              className="w-full px-4 py-3.5 border border-gray-300 rounded-md text-base text-gray-900 placeholder-gray-400 outline-none focus:border-[#d31464] transition-colors resize-y"
            />
          </div>
          ...
          <div className="flex items-start gap-3">
            <input
              ...
              onChange={handleChange}
              className="mt-0.5 w-4.5 h-4.5 flex-shrink-0 accent-[#d31464] cursor-pointer"
            />
            <label
            ...
            >
              ...
              <a href="/privacy-policy" className="text-[#d31464] underline">
                Privacy Policy
              </a>{" "}
              and{" "}
              <a href="/terms-of-use" className="text-[#d31464] underline">
                Terms of Use
              </a>
              .
            </label>
          ...
          <button
            type="submit"
            className="w-full py-4 bg-[#d31464] hover:bg-[#d31464] text-white font-semibold text-base rounded-md transition-colors duration-200 tracking-wide cursor-pointer"
          >
            Submit
          </button>
        </form>
