    ...
    <div className="flex flex-col min-h-screen">
      ...
      <header className="bg-white border-b border-gray-200 px-5 py-3.5 sticky top-0 z-50">
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          ...
          <Link
            href="/about"
            className="text-sm font-medium text-[#d31464] underline underline-offset-2"
          >
            About Us
          </Link>
        </div>
      ...
      {/* Hero */}
      <section className="bg-[#d31464] text-white px-5 py-16 text-center">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-5 py-12">
        <div className="space-y-10">
          ...
          <section>
            ...
            <ul className="space-y-3 text-gray-600">
              <li className="flex items-start gap-3">
                <span className="text-[#d31464] font-bold mt-0.5">✓</span>
          ...
          <section className="bg-gray-50 rounded-xl p-8 text-center">
            ...
            <Link
              href="/"
              className="inline-block px-8 py-3 bg-[#d31464] hover:bg-[#d31464] text-white font-semibold rounded-md transition-colors duration-200"
            >
              Get Started
            </Link>
          </section>
